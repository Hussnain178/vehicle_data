...
class OtomotoScraper:
    ...
    def __init__(self, config: Optional[ScraperConfig] = None):
        ...
        self.headers = {
            ...
            "referer": "https://www.otomoto.pl/osobowe?search[order]=created_at_first:desc&search[advanced_search_expanded]=true",
            ...
            "priority": "u=1, i",
            "x-transaction-id": "uwZBJtcNg4TCtrDhYi-q6Xy9xp2A-0Bb48qaIPPxPXHkXx1TiHQOeg==",
        }
